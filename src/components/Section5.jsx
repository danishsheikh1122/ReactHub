...
const Section5 = () => {
  return (
    <>
      <section class="bg-black overflow-hidden font-bricolage" id="pricing">
        <div class="py-24 pb-0 px-8 max-w-5xl mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            <p class="font-medium text-[#E1AC18] mb-8">Pricing</p>
            <h2 class="font-bold text-3xl text-[#CFCFCF] lg:text-5xl tracking-tight mb-8 max-w-2xl mx-auto">
            ...
            <p class="text-sm md:text-base flex justify-center items-center gap-2 ">
              <svg
                class="w-5 h-5 fill-accent animate-pulse"
                viewBox="0 0 161 154"
                fill="none"
              ...
              <span className="text-[#CFCFCF]">
                <span class="text-accent">$100 off</span> for the first 3540
                customers (13 left)
              </span>
            </p>
          </div>
          <div class="relative flex flex-col lg:flex-row items-center lg:items-stretch gap-8 ">
            <div class="relative w-full">
              <div class="relative flex flex-col gap-5 lg:gap-8 z-10 text-[#CFCFCF] bg-[#212121] p-8 rounded-lg">
                <div class="flex justify-between items-center gap-4 text-[#CFCFCF]">
                  <div>
                ...
                <div class="flex gap-2">
                  <div class="flex flex-col justify-end mb-[4px] text-lg ">
                    <p class="relative opacity-80">
                      <span class="absolute bg-base-content h-[1.5px] inset-x-0 top-[48%]"></span>
                      <span class="text-[#CFCFCF]">$269</span>
                    </p>
                  </div>
                  <p class="text-5xl tracking-tight font-extrabold">$169</p>
                  <div class="flex flex-col justify-end mb-[4px]">
                    <p class="text-xs opacity-60 uppercase font-semibold">
                      USD
                    </p>
                  </div>
                </div>
                <ul class="space-y-2.5 leading-relaxed text-base flex-1">
                  <li class="flex items-center gap-2">
                    ...
                    <span class="">NextJS boilerplate</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li class="flex items-center gap-2">
                    ...
                    <span class="">Mailgun emails</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="">Stripe / Lemon Squeezy</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="">MongoDB / Supabase</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="">Google Oauth &amp; Magic Links</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="">Components &amp; animations</span>
                  </li>
                  <li class="flex items-center gap-2 ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      class="w-5 h-5 text-[#CFCFCF]/30 shrink-0"
                    >
                      <path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z"></path>
                    </svg>
                    <span class="text-[#CFCFCF]/30 ">
                  ...
                  <li class="flex items-center gap-2">
                    ...
                    <span class="text-[#CFCFCF]/30">Lifetime updates</span>
                  </li>
                </ul>
                <div class="space-y-2">
                  <button
                    class="btn bg-[#E1AC18] border-none group btn-block plausible-event-name=Checkout"
                  ...
                  <p class="flex items-center justify-center gap-2 text-sm text-center text-[#CFCFCF]/80 font-medium relative">
            ...
            <div class="relative w-full ">
              <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 ">
                <span class="badge text-xs bg-[#E1AC18] font-semibold border-0 ">
                  POPULAR
                </span>
              </div>
              <div class="absolute -inset-[2px] rounded-[8px] bg-[#E1AC18] z-10"></div>
              <div class="relative flex flex-col gap-5 lg:gap-8 z-10  text-[#CFCFCF] bg-[#212121] p-8 rounded-lg">
                <div class="flex justify-between items-center gap-4">
                  <div>
                    <p class="text-lg lg:text-xl font-bold ">All-in</p>
                  </div>
                </div>
                <div class="flex gap-2">
                  <div class="flex flex-col justify-end mb-[4px] text-lg ">
                    <p class="relative opacity-80">
                      <span class="absolute bg-base-content h-[1.5px] inset-x-0 top-[48%]"></span>
                      <span class="text-[#CFCFCF]">$299</span>
                    </p>
                  </div>
                  <p class="text-5xl tracking-tight font-extrabold">$199</p>
                  <div class="flex flex-col justify-end mb-[4px]">
                    <p class="text-xs opacity-60 uppercase font-semibold">
                      USD
                    </p>
                ...
                <ul class="space-y-2.5 leading-relaxed text-base flex-1">
                  ...
                  <li class="flex items-center gap-2">
                    ...
                    <span class="">Discord community &amp; Leaderboard</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="">
                      Lifetime updates
                      <span
                        class="badge badge-accent select-none cursor-pointer ml-1"
                        data-tooltip-id="tooltip"
                        data-tooltip-html='<div class="text-gray-300"><div class="mb-1.5 ">Latest updates on ShipFast:</div><ul><li>- <span class="text-gray-50 font-medium">(new) Features Grid component 🧱</span> <span class="badge badge-sm">2 weeks ago</span></li><li>- <span class="text-gray-50 font-medium">(new) Compete for the Leaderboards 🥇</span> <span class="badge badge-sm">1 month ago</span></li><li>- <span class="text-gray-50 font-medium">Merge remote-tracking branch &amp;#x27;refs/remotes/ship-fast-org/main&amp;#x27;</span> <span class="badge badge-sm">1 month ago</span></li></ul></div>'
                      >
                        Updated 2 weeks ago
                      </span>
                    </span>
                ...
                <div class="space-y-2">
                  ...
                  <p class="flex items-center justify-center gap-2 text-sm text-center text-[#CFCFCF]/90 font-medium relative">
                    Pay once. Build unlimited projects!
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4 mx-auto max-w-md mt-24">
            ...
            <p className="md:text-lg leading-relaxed text-[#CFCFCF]
            ">
            ...
            <div className="flex items-center gap-2">
              <img
                alt="Mateus testimonial for ShipFast"
                loading="lazy"
                width="48"
                height="48"
                decoding="async"
                ...
                srcSet="https://shipfa.st/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmateus.576bf51a.webp&w=48&q=75"
                src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmateus.576bf51a.webp&amp;w=96&amp;q=75"
              />
              <p className="text-[#CFCFCF]">Mateus De Nardo</p>
