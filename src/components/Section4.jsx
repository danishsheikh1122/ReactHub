...
const Section4 = () => {
  return (
    <>
      <section className="bg-[#212121] text-white font-bricolage" id="demo">
        <div className="py-24 max-md:px-8 max-w-3xl mx-auto text-white">
          <div className="leading-relaxed text-white/80 mb-12 max-w-xl mx-auto text-white">
            <img
            ...
            <p className="mb-5">
              ...
              <a
                className="link text-white font-medium hover:link-accent whitespace-nowrap"
                target="_blank"
                href="https://marclou.com?ref=shipfast_intro"
              >
            ...
            <ul className="list-inside list-decimal space-y-1.5 ml-5 mb-5">
              <li>
                ...
                focus on what matters: building a business
              </li>
              <li>
                <span className="text-white font-medium">Avoid headaches</span>{" "}
            ...
            <p>
              <a
                className="link whitespace-nowrap text-white hover:link-accent font-medium group"
                target="_blank"
              ...
              <a
                className="link whitespace-nowrap text-white hover:link-accent font-medium group"
                target="_blank"
                href="https://www.producthunt.com/golden-kitty-awards/hall-of-fame#maker-of-the-year"
              >
              ...
              are using ShipFast to launch startups quickly, scroll to see what
              they say.
            </p>
          </div>
          <div className="relative max-sm:-mx-8 mb-16">
            <div className="max-lg:hidden absolute top-1/4 -left-4 -translate-x-full text-sm flex flex-col gap-1 items-center">
              <p className="text-white/80">The code in 3 minutes</p>
              <svg
                class="w-12 h-12 fill-opacity-80"
                viewBox="0 0 130 130"
          ...
          <div className="space-y-4 max-w-md mx-auto">
            ...
            <div className="flex items-center gap-2">
              <img
                ...
                style={{ color: "transparent" }}
                srcset="https://shipfa.st/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fyifan.d4b261ef.jpeg&w=48&q=75"
                src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fyifan.d4b261ef.jpeg&amp;w=96&amp;q=75"
              />
              <p>Yifan Goh</p>
